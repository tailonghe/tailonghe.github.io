...
author_profile: true
---
<blockquote style="background-color:#f5f7fa; border-left:4px solid #2196F3; padding:15px 20px; margin-top:0; overflow:hidden; width:min(90vw, 1200px); position:relative; left:50%; transform:translateX(-50%);">
...
<blockquote style="background-color:#f5f7fa; border-left:4px solid #4CAF50; padding:15px 20px; margin-top:0; overflow:hidden; width:min(90vw, 1200px); position:relative; left:50%; transform:translateX(-50%);">
...
<blockquote style="background-color:#f5f7fa; border-left:4px solid #FF9800; padding:15px 20px; margin-top:0; overflow:hidden; width:min(90vw, 1200px); position:relative; left:50%; transform:translateX(-50%);">
...
<blockquote style="background-color:#f5f7fa; border-left:4px solid #F44336; padding:15px 20px; margin-top:0; overflow:hidden; width:min(90vw, 1200px); position:relative; left:50%; transform:translateX(-50%);">
